...
document.addEventListener("DOMContentLoaded", function() {
  ...
  .then(data => {
    ...
    for (const work of data.portfolio) {
      ...
      slide.innerHTML = `<div class="numbertext">${work.number} / 10</div><img src="${work.image}"><div class='text'><span class='title'>${work.title}</span><span class='caption'>${work.caption}</span></div>`;
    //append to the ul
