...
const noise = () => {
  ...
  for (let i = 0; i < imageData.data.length; i += 4) {
    const value = Math.floor(Math.random() * 50); // darker value
    imageData.data[i] = value + 200; // add 200 for contrast
    imageData.data[i + 1] = value + 200; // add 200 for contrast
    imageData.data[i + 2] = value + 200; // add 200 for contrast
